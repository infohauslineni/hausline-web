...
},
{
  ...
  categoria:"Zapatos",
  nuevo:true,
  imagen:"imgP/ZAPATOS MEN/OFF-WHITE/OFW005/1.jpg",
  imagenes:[
...
const nombresReales = {
  ...
  "OFW005": { nombre: "Off-White Low Vulcanized Blanco Flecha Roja", descripcion: "Sneaker bajo de lona blanca con flecha diagonal roja bordada al lateral, franjas diagonales negras en el borde y cinta \"SHOELACES\" en el empeine. Suela vulcanizada blanca." },
...
const PROMOCIONES = [
  {
    ...
    categoria: "Ropa",                    // se aplica a toda la ropa
...
const ETIQUETAS_OPCIONALES = [
  ...
  // El texto cambia solo: "Última unidad" si queda 1, "Últimas unidades" si hay más.
  { propiedad: "ultimasUnidades",
    texto: p => (Number(p.cantidadDisponible) === 1 ? "Última unidad" : "Últimas unidades"),
    color: "rojo" },
...
// El "texto" puede ser fijo o una función que lo calcula según el producto.
function etiquetasActivas(producto){
  return ETIQUETAS_OPCIONALES
    .filter(e => producto[e.propiedad])
    .map(e => ({
      color: e.color,
      texto: typeof e.texto === "function" ? e.texto(producto) : e.texto
    }));
}
